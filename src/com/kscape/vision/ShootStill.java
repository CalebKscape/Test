...
public class ShootStill {
    ...
    public static void main(String[] args) {
        ...
        try {
            String saveDir = "/home/pi/IdeaProjects/JavaTest/Pictures";
    ...
    public static void shootStill(RPiCamera piCamera) {
        ...
        try {
            File image = piCamera.takeStill("A Picture.png", 650, 650);
    ...
    git remote set-url origin git://https:github.com/CalebKscape/Test